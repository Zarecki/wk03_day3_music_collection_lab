...
artist1 = Artist.new({'name' => 'After Avril'})
artist1.save

artist2 = Artist.new({'name' => 'F**k Your Yankee Blue Jeans'})
artist2.save

album1 = Album.new({'title' => 'Self Titled', 'genre' => 'Beat Poetry', 'artist_id' => artist1.id})
album1.save

album2 = Album.new({'title' => 'Berzerker', 'genre' => 'Metal', 'artist_id' => artist2.id})
album2.save
